...
--
CREATE DATABASE IF NOT EXISTS `db_akademik_0495` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_akademik_0495`;

-- --------------------------------------------------------

--
-- Table structure for table `tbl_students_0495`
--

CREATE TABLE IF NOT EXISTS `tbl_students_0495` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0495`
--

INSERT INTO `tbl_students_0495` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
(1, '20.90.1234', 'Mansur Tri N', 'L', 'Teknik Komputer', 'Yogyakarta'),
